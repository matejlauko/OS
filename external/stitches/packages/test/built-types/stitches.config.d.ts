...
import type * as Stitches from '@matejlauko/stitches-react'
export type { VariantProps } from '@matejlauko/stitches-react'
export declare const styled: <
    Type extends
      | import('@matejlauko/stitches-react/types/util').Function
    ...
    CSS_1 = import('@matejlauko/stitches-react/types/css-util').CSS<
      {
        bp1: '(min-width: 520px)'
        bp2: '(min-width: 900px)'
    ...
    ...composers: {
      [K in keyof Composers]: string extends Composers[K]
        ...
        : Composers[K] extends
            ...
            | import('react').ComponentType<any>
        ? Composers[K]
        : import('@matejlauko/stitches-react/types/stitches').RemoveIndex<CSS_1> & {
            variants?:
              | {
                  [x: string]: {
                    [x: string]: CSS_1
            ...
            compoundVariants?:
              | (('variants' extends keyof Composers[K]
                  ? Composers[K][keyof Composers[K] & 'variants'] extends infer T
                    ? {
                        [Name in keyof T]?:
                          | import('@matejlauko/stitches-react/types/util').String
                          | import('@matejlauko/stitches-react/types/util').Widen<
                              keyof Composers[K][keyof Composers[K] & 'variants'][Name]
                            >
                          | undefined
                      }
                    : never
                  : import('@matejlauko/stitches-react/types/util').WideObject) & {
                  css: CSS_1
                })[]
              | undefined
            defaultVariants?:
  ...
  ) => import('@matejlauko/stitches-react/types/styled-component').StyledComponent<
    Type,
    import('@matejlauko/stitches-react/types/styled-component').StyledComponentProps<Composers>,
    {
      bp1: '(min-width: 520px)'
      bp2: '(min-width: 900px)'
      bp3: '(min-width: 1200px)'
  ...
  >(
    ...
    selector: string
      ...
      ? import('@matejlauko/stitches-react/types/stitches').ThemeTokens<Argument1, ''>
      : import('@matejlauko/stitches-react/types/stitches').ThemeTokens<Argument0, ''>),
  getCssText: () => string,
  keyframes: (style: {
    [offset: string]: import('@matejlauko/stitches-react/types/css-util').CSS<
      {
        bp1: '(min-width: 520px)'
        bp2: '(min-width: 900px)'
        bp3: '(min-width: 1200px)'
...
export declare const darkTheme: string & {
  className: string
  selector: string
} & import('@matejlauko/stitches-react/types/stitches').ThemeTokens<
    {
      colors: {
        hiContrast: string
        loContrast: string
