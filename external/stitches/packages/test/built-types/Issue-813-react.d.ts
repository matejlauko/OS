    ...
    ...composers: {
      [K in keyof Composers]: string extends Composers[K]
        ...
        : Composers[K] extends
            ...
            | import('react').ComponentType<any>
        ? Composers[K]
        : import('@matejlauko/stitches-react/types/stitches').RemoveIndex<CSS> & {
            variants?:
              | {
                  [x: string]: {
                    [x: string]: CSS
...
export declare const Box: import('@matejlauko/stitches-react/types/styled-component').StyledComponent<
  'div',
  {},
  {},
  import('@matejlauko/stitches-react/types/css-util').CSS<
